...
public class MenuDisplay {
     ...
     * 2. Mostrar paciente por DNI.
     * 3. Mostrar paciente por ID.
    ...
    public static void mostrarMenuPrincipal() {
        ...
        System.out.println("3. Mostrar paciente por ID");
        ...
        System.out.println("8. Mostrar Historial Clinico por DNI del paciente");
        System.out.println("9. Mostrar Historial Clinico por numero de historial");
